...
use channel_plugin::{
    message::{
        ...
        MessageOutResult, NameResult, Participant, StateResult, StopResult, PLUGIN_VERSION,
    },
...
impl PluginHandler for MockPlugin {
    ...
    async fn receive_message(&mut self) -> MessageInResult {
        ...
        let content = MessageContent::Text {
            text: "mock says hello".to_string(),
        };
        msg.content = vec![content];
        let participant = Participant {
            id: "mockingbird".to_string(),
            display_name: None,
